 ...
 * Use the {@link Products_Fragment#newInstance} factory method to
...
public class Products_Fragment extends Fragment {
    ...
    public static Products_Fragment newInstance(String param1, String param2) {
    ...
    public static Products_Fragment newInstance(String param1) {
        Products_Fragment fragment = new Products_Fragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, param1);
        fragment.setArguments(args);
